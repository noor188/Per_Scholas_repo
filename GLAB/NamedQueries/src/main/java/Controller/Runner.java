...
public class Runner {
    public static void main(String[] args) {
       ...
       // createTable(factory, session);
       // findEmployeeById(factory);
        findEmployeeByName(factory);
        showOfficeCodesAsDepartment(factory);

    }

    public static void createTable(SessionFactory factory, Session session){
    ...
    public static void findEmployeeByName(SessionFactory factory) {
        Session session = factory.openSession();
//------------  Hibernate Named Query   -------------
    ...
    public static void findEmployeeById(SessionFactory factory) {
        Session session = factory.openSession();
//------------  Hibernate Named Query   -------------
    ...
    public static void showOfficeCodesAsDepartment(SessionFactory factory) {
        Session session = factory.openSession();
//------------  Hibernate Named Query   -------------
